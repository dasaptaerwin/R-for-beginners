---
title: "Bab 3 Package dan syntax R"
...
Dalam bab ini kami berusaha mengenalkan _package dan syntax R_. Dalam R, fungsi dapat dibuat dan dikustomisasi sesuai kebutuhan pengguna. Oleh karenanya di saat jumlah baris perintah atau fungsi dasar (_base command/base function_) terus bertambah untuk menyelesaikan satu masalah, maka hampir dipastikan ada orang yang mengembangkan package tambahan yang menyederhanakan baris-baris perintah tersebut. Selain itu dalam bab ini pembaca juga dikenalkan format (syntax) penulisan perintah dalam R. Bila anda akrab dengan bahasa pemrograman, maka penempatan fungsi dan argumen sudah tidak asing lagi. Hanya perlu sedikit penyesuaian. Untuk anda yang baru mengenai pemrograman (seperti halnya kami), maka tidak ada jalan lain selain menghapal dan banyak berlatih.
