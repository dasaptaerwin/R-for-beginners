...
+ [DasaptaErwin](www.dasaptaerwin.net/wp)
+ [Situs R Studio](http://www.rstudio.com/) 
+ [R base packages](https://stat.ethz.ch/R-manual/R-devel/library/base/html/00Index.html)
+ [R Commander](http://www.rcommander.com/)
+ [R-evolution](http://blog.revolutionanalytics.com/2013/05/how-r-grows.html)
+ [R user group](http://r-users-group.meetup.com/)
